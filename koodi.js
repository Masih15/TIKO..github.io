let tanaan = new Date("2026-07-27");
...
let kesakalenteri = {
    ...
    viikot: [
        { numero: 1, teksti: "Käy uimassa"},
        { numero: 2, teksti: "Treenaa kesäkuntoon"},
        { numero: 3, teksti: "Pelaa Mölkkyä"},
        { numero: 4, teksti: "Jalkapallon MM-kisat alkaa"},
        { numero: 5, teksti: "Käy golffaamassa"},
        { numero: 6, teksti: "Syö jäätelöä"},
        { numero: 7, teksti: "Käy korkeasaaressa, mene kruunuvuoren sillan kautta"},
        { numero: 8, teksti: "Mene linnanmäelle"},
        { numero: 9, teksti: "Katso MM-kisjoen finaali"},
        { numero: 10, teksti: "Kiipeile ulkona"},
        { numero: 11, teksti: "Tuplaa voitot kasinolla!"},
        { numero: 12, teksti: "Haloo Helsinki-konsertti"},
